...
Begin VB.Form frmMain 
   ...
   Begin TabDlg.SSTab sstConfiguration 
      ...
      Tab(0).Control(4)=   "famXAxies"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "famYAxies"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "dbcConfiguration"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "cmdSaveConfig"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "txbPointDataTableOffset"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "txbScannerOffsetLine"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "txbBoardCountCodeLine"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "txtbOffSet"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).ControlCount=   12
      TabCaption(1)   =   "Data points"
      TabPicture(1)   =   "ConfigAdmin.frx":045E
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "cmdSaveDP"
      Tab(1).Control(1)=   "dbcMachineDataPt"
      Tab(1).Control(2)=   "dbgMachineDataPt"
