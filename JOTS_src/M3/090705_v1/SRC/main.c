...
int main()
{
	 ...
	 */
	timeout.tv_sec = (unsigned int) 1;
	timeout.tv_usec = 0;
//	nWatchDogTimer=open("/dev/watchdog",O_WRONLY);
//	if (nWatchDogTimer==-1)
//		printf("Error Opening WatchDog Timer");	
//	fcntl(nWatchDogTimer,F_SETFD,FD_CLOEXEC);
	while (1)
	{
		/*
