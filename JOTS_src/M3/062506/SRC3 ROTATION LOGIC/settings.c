...
{ 
	...
	/*Motion Controller Settings Added 051806 */

	Settings.mcontroller.dev = iniparser_getstr(d, "MotionController:dev");
	Settings.mcontroller.baud = iniparser_getint(d, "MotionController:baud", 38400);
	Settings.mcontroller.description = iniparser_getstr(d, "MotionController:description");
	...
	Settings.nEnableMotionController = iniparser_getint(d, "application:EnableMotionController",0);
	...
	if (Settings.nEnableMotionController==1)
	{
	    printf("\tEnableMotionController = \t\t[%s]\n\n","TRUE");
	    printf("\tSettings.mcontroller.dev = %s\n", Settings.mcontroller.dev);
  	    printf("\tSettings.mcontroller.baud = %d\n", Settings.mcontroller.baud);
	    printf("\tSettings.mcontroller.description = %s\n", Settings.mcontroller.description);

	}
	else
	    printf("\nEnableMotionController = \t\t[%s]\n\n","FALSE");
