...
arm-linux-gcc -o aik2 main.o input.o commands.o gpio.o serial.o csv.o settings.o iniparse/iniparser.o iniparse/dictionary.o iniparse/strlib.o PrintAndApply.o -ldevmem
