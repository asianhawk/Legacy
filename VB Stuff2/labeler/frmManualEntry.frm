...
Begin VB.Form frmManualEntry 
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   "No Bar Code was Scanned From The Bottom Label. Enter Value Manually and Press OK, or Press Cancel to Pause the Job."
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   12
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmManualEntry"
...
Private Sub cmdOK_Click()
   ...
   If g_blnBoardRemove Then
      MsgBox ("Board Removed Switch Not Closed")
   End If
