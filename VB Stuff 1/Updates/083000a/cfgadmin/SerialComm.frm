...
Begin VB.Form frmSerialComm 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   529
      TabCaption(0)   =   "Output"
      TabPicture(0)   =   "SerialComm.frx":0442
      ...
      TabCaption(1)   =   "Input"
      TabPicture(1)   =   "SerialComm.frx":045E
      ...
      TabPicture(2)   =   "SerialComm.frx":047A
...
Private Sub tmrWatchDog_Timer(Index As Integer)
   ...
   If (comSerialComm(Index).PortOpen) Then
        comSerialComm(Index).PortOpen = False
        SleepSec (1)
        comSerialComm(Index).PortOpen = True
    End If
